module Baslash
  module Debug
    module MetaSeeds
      ROWS = [
        ["db",     "baslash_debug",        "baslash debug session — frame log + sqlite-vec semantic", nil, nil, nil],
        ...
        ["column", "frames.framework_state_json", "JSON snapshot of baslash framework state", nil, nil, nil],
        ["recipe", "popup_active",
