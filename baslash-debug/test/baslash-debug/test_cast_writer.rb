...
require "json"
require "stringio"
require "baslash/debug/cast_writer"

class TestCastWriter < Test::Unit::TestCase
  def test_writes_v2_header_first_line
    io = StringIO.new
    Baslash::Debug::CastWriter.write(io, frames: [], rows: 24, cols: 80, started_at: 1234567890)
  ...
  def test_each_frame_is_o_event_line
    ...
    io = StringIO.new
    Baslash::Debug::CastWriter.write(io, frames: frames, rows: 24, cols: 80, started_at: 0)
