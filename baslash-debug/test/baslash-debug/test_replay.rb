...
class TestReplay < Test::Unit::TestCase
  def setup
    ...
    RUBY
    result = Baslash::Debug::SpecDSL.evaluate(src, db_path: @db, spec_path: "<inline>")
  ...
  def test_speed_zero_emits_full_output_in_under_100ms
    ...
    Baslash::Debug::Replay.to_io(db_path: @db, session_uuid: @uuid, io: io, speed: 0)
  ...
  def test_replay_only_emits_output_events_not_input_or_exit
    ...
    io = StringIO.new
    Baslash::Debug::Replay.to_io(db_path: @db, session_uuid: uuid2, io: io, speed: 0)
  ...
  def test_replay_of_unknown_uuid_emits_nothing
    io = StringIO.new
    Baslash::Debug::Replay.to_io(db_path: @db, session_uuid: "no-such-uuid", io: io, speed: 0)
