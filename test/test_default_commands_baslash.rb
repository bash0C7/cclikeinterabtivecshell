...
require "baslash/default_commands"

class TestDefaultCommandsBaslash < Test::Unit::TestCase
  def setup
    @registry = Baslash::SlashRegistry.new
    Baslash::DefaultCommands.register(@registry)
    Baslash::DefaultCommands.register_help(@registry)
  end
