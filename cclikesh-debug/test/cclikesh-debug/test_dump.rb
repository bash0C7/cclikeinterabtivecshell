...
class TestDump < Test::Unit::TestCase
  ...
  def test_dump_includes_ts_dir_hex_and_printable_ascii
    io = StringIO.new
    Cclikesh::Debug::Dump.to_io(db_path: @db, session_uuid: @uuid, io: io, io_filter: "both")
  ...
  def test_dump_io_filter_input_only
    io = StringIO.new
    Cclikesh::Debug::Dump.to_io(db_path: @db, session_uuid: @uuid, io: io, io_filter: "i")
  ...
  def test_dump_io_filter_output_only
    io = StringIO.new
    Cclikesh::Debug::Dump.to_io(db_path: @db, session_uuid: @uuid, io: io, io_filter: "o")
